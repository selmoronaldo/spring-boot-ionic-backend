...
public class Cliente implements Serializable {
	...
	@JsonIgnore	//para não mostrar no retorno do json
	...
	public Cliente() {	
		addPerfil(Perfil.CLIENTE); //quando instanciar já tem o perfil de cliente para todos
	}
	...
	public TipoCliente getTipo() {
		return TipoCliente.toEnum(tipo); //utilizando o enum que pega um TipoCliente
	}
